#!/bin/bash
# Claude Model Router v3.0 - Uninstallation Script

echo ""
echo "+---------------------------------------------------------+"
echo "|  Claude Model Router v3.0 - Uninstallation              |"
echo "+---------------------------------------------------------+"
echo ""

read -p "  Uninstall the Model Router? (y/N) " -n 1 -r
echo ""
...
if echo "$CURRENT_HOOKS_PATH" | grep -q "model-router"; then
